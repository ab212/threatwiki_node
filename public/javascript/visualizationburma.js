$(document).ready(function() {
	...
	jQuery.getJSON(host+"/api/datapoint/soc/Myanmar?callback=?", function(datapoints) {
		////////////////////////////////////////
		...
		function iranjson() {
			d3.json("/mapfiles/burma.json", function(error, data) {
		...
		barChart()
			...
			.x(d3.time.scale.utc()
				.domain([new Date(2013, 03,15), new Date()])
				.rangeRound([0, 960]))
		];
